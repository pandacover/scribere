...
const Navbar = () => {
  ...
  return (
    <header className='border dark:border-zinc-800 flex justify-between items-center w-full h-16 px-6'>
      <p className='lowercase text-4xl font-medium font-serif flex items-center gap-2 dark:text-white'>
        <span>Scrībere</span>
      </p>
      <div className='flex-1 flex justify-end gap-8 items-center'>
        ...
        <div className={`select-none relative flex items-center p-2 group hover:bg-surface-black transition cursor-pointer ${toggleMenu ? 'bg-surface-black' : ''}`} onClick={e => handleToggleMenu(e)}>
          <div className='flex gap-2 items-center'>
            ...
            <figure>
              <svg className='group-hover:translate-y-2 fill-black group-hover:fill-white dark:fill-white dark:group-hover:fill-gray-400 transition' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className={`transition absolute w-48 bg-surface-black scale-0 text-white -left-[111px] top-[50px] p-2 grid grid-flow-row ${toggleMenu ? 'scale-100' : ''}`}>
